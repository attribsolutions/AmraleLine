...
public class ACR120U
{
    ...
    public static extern short ACR120_Open(int ReaderPort);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Close(int hReader);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Reset(int hReader);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Status(int hReader, ref byte pFirmwareVersion, ref tReaderStatus pReaderStatus);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_ReadRC531Reg(int hReader, byte RegNo, ref byte pRegData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_WriteRC531Reg(int hReader, byte RegNo, byte pRegData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_DirectSend(int hReader, byte DataLength, ref byte pData,
                                               ref byte pResponseDataLength, ref byte pResponseData, int TimedOut);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_DirectReceive(int hReader, byte RespectedDataLength, ref byte pReceivedDataLength,
                                                  ref byte pReceivedData, int TimedOut);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_RequestDLLVersion(ref byte pVersionInfoLen, ref byte pVersionInfo);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_ReadEEPROM(int hReader, byte RegNo, ref byte pEEPROMData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_WriteEEPROM(int hReader, byte RegNo, byte eePROMData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_ReadUserPort(int hReader, ref byte pUserPortState);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_WriteUserPort(int hReader, byte userPortState);
    ...
    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Select(int hReader, ref byte pResultTagType,
                                           ref byte pResultTagLength, ref byte pResultSN);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Login(int hReader, byte Sector, int keyType,
                                          byte storedNo, ref byte pKey);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Read(int hReader, byte Block, ref byte pBlockData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_ReadValue(int hReader, byte Block, ref long pValueData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Write(int hReader, byte Block, ref byte pBlockData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_WriteValue(int hReader, byte Block, long ValueData);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_WriteMasterKey(int hReader, byte keyNo, ref byte pKey);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Inc(int hReader, byte Block,
                                        long value, ref long pNewValue);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Dec(int hReader, byte Block,
                                        long value, ref long pNewValue);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Copy(int hReader, byte srcBlock,
                                         byte desBlock, ref long pNewValue);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_Power(int hReader, byte State);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_ListTags(int hReader, ref byte pNumTagFound, ref byte pTagType,
                                             ref byte pTagLength, ref byte pSN);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_MultiTagSelect(int hReader, byte TagLength, ref byte SN,
                                                   ref byte pResultTagType, ref byte pResultTagLength,
                                                   ref byte pResultSN);

    [DllImport("ACR120U.DLL")]
    public static extern short ACR120_TxDataTelegram(int hReader, byte SendDataLength, ref byte pSendData,
                                                   ref byte pReceivedDataLength, ref byte pReceivedData);

    // Error routines
    public static string GetErrMsg(short code)
    {
        switch (code)
        {
            case -1000:
            ...
            case -4031:
                return ("Increment value overflow : -4031");

            case -4032:
                return ("Value block operation failed : -4032");

            case -4033:
                return ("Invalid Value Block : -4033");

            case -4034:
                return ("Value Block Access Failure : -4034");

            case -5000:
                return ("No response from reader : -5000");
